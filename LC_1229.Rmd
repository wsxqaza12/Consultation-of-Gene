...
```{r setup, echo=FALSE}
counts = read.csv("C:/Users/User/Desktop/研究所/碩二上/課. 統計諮詢1/1228/LC_47_count.csv",
                  row.names= 1)
info = read.csv("C:/Users/User/Desktop/研究所/碩二上/課. 統計諮詢1/1228/LC_47.csv",
                row.names= 1)
...
## 7. Dirichlet model
```{r}
importantRNA_deviance <- c(707,1257,2777,3808,3901,4052,
                           5894,6101,7098,8210,9689,9733)
Di_data <- as.data.frame(Lc[, (importantRNA_deviance)]) %>% cbind(info/100)

mod2 <- DirichReg(precentLC~ .-Feature_A -Feature_B- Feature_C, data = Di_data)
